...
export default function Users() {
  ...
  return (
    <>
      <Navbar />
      {/* Start block */}
      <section className="dar k:bg-gray-900 p-3 sm:p-5 antialiased">
              ...
              <table className="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                ...
                <tbody>
                  <tr className="border-b dark:border-gray-700">
                    ...
                    <td className="px-4 py-3">11/07/2023 09:03</td>
                    <td className="px-4 py-3 max-w-[12rem] truncate">
                      Administrador
                    </td>
                    <td className="px-4 py-3">Financeiro</td>
      ...
      <Modal isOpen={isOpenAddModal} toggle={toggleAddModal}>
        {/* Modal header */}
      ...
      <Modal isOpen={isOpenEditModal} toggle={toggleEditModal}>
        {/* Modal header */}
        <div className="flex justify-between items-center pb-4 mb-4 rounded-t border-b sm:mb-5 dark:border-gray-600">
          <h3 className="text-lg font-semibold text-gray-900 dark:text-white">
            Usuário
